# see: https://github.com/micropython/micropython-lib/blob/master/micropython/usb/README.md
# see: https://github.com/micropython/micropython-lib/blob/master/micropython/usb/examples/device/keyboard_example.py
